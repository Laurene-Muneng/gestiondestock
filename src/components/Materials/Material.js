    ...
    <>
      <tr>
        ...
        <td>
          <div className="buttons-set">
            ...
            <button
              onClick={() =>
                showForm(() => setCheckoutMaterial(!checkoutMaterial))
              }
            >
              Sorties
            </button>
            ...
            <button
              onClick={() =>
                showForm(() => setCheckinMaterial(!checkinMaterial))
              }
            >
              Entrees
            </button>
      ...
      {checkoutMaterial && (
        <tr>
          <td></td>
          <td colSpan={10}>
            <CheckOutForm materialId={material.id} />
          </td>
        </tr>
      )}
      ...
      {checkinMaterial && (
        <tr>
          <td></td>
          <td colSpan={10}>
            <CheckInForm materialId={material.id} />
          </td>
        </tr>
      )}
    </>
